...
const Hero = () => {
  return (
    <section className="relative overflow-hidden">
      {/* Top content section */}
      <div className="relative min-h-screen flex items-center justify-center pt-20 md:pt-16">
          ...
          <div className="relative z-10 container mx-auto px-6 text-center pt-4 md:pt-0">
            {/* Badge */}
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
              NPI-verified, deterministic healthcare professional audiences. Not based on behavior, context, or assumption. <strong className="text-foreground">Precision guaranteed.</strong>
            </p>
      ...
      {/* FIXED: Scroll-triggered animation section is now properly sized and structured */}
      <div className="w-screen relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw]">
        <div className="h-24 bg-gradient-to-b from-background via-background/80 to-black"></div>
        
        {/* This container is now a fixed height (screen height) to provide a stable pinning area */}
