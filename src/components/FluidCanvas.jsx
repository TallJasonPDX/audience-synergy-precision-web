 ...
 */
export default function FluidCanvas({ width = "100%", height = "100%" }) {
  const containerRef = useRef(null);
  const canvasRef = useRef(null);

  useEffect(() => {
    // This function will run after the component has been rendered
...
`
    ...
    void main () {
        ...
        if(gl_FragColor.rgb == vec3(0.0, 0.0, 0.0)) { // check if the color is black or any other color you treat as background
        gl_FragColor.a = 0.0; // set alpha to 0
    }
